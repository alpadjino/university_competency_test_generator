...
export const ClosedQuestionSubtypeEnumModel = {
  type: DataTypes.ENUM,
  values: [
  ...
  name: 'closed_question_subtype',
};

export const OpenQuestionSubtypeEnumModel = {
  type: DataTypes.ENUM,
  values: [OpenQuestionSubtype.ADDITION, OpenQuestionSubtype.DETAILED_ANSWER],
  name: 'open_question_subtype',
};